...
export default function COSModal({ job, currentUser, onClose, onSuccess }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl w-full max-w-3xl h-[90vh] flex flex-col overflow-hidden border-t-[6px] border-[#3B82F6] relative"
        ...
        {submitted ? (
          ...
          <>
            <div className="flex-1 overflow-y-auto p-10">
              <p className="text-[12px] font-bold tracking-[3px] uppercase text-[#3B82F6] mb-2">
                Contract of Service
              </p>
              <h2
              ...
              {[
                ...
                <div key={title} className="mb-7">
                  <h3
                    className="text-[13px] font-bold tracking-[2px] uppercase text-[#0A1F5C] border-b-2 border-[#3B82F6] pb-2 mb-3"
                    style={{ fontFamily: "'Barlow Condensed',sans-serif" }}
                  >
                    {title}
                  </h3>
            ...
            <div className="flex-shrink-0 p-6 border-t-2 border-gray-100 flex justify-center">
              <button
                ...
                className="bg-[#3B82F6] border-0 text-white font-black text-xl tracking-[2px] uppercase px-16 py-4 rounded transition-all duration-200 hover:bg-[#0A1F5C] hover:-translate-y-0.5 cursor-pointer"
                style={{
          ...
          <>
            <div className="flex-shrink-0 px-10 pt-7 pb-5 border-b-2 border-gray-100">
              <button
                ...
                className="flex items-center gap-1.5 text-[13px] font-bold tracking-wider uppercase text-[#0A1F5C] hover:text-[#3B82F6] transition-colors mb-3 bg-transparent border-0 cursor-pointer"
              >
                <ChevronLeft size={14} />
                Back to Details
              </button>
            ...
            <div className="flex-1 overflow-y-auto px-10 py-8 bg-gray-50/50">
              ...
              {step === 4 && (
                <FormCard title="Upload Requirements">
                  ...
                  <div className="relative border-2 border-dashed border-[#3B82F6] bg-blue-50 hover:bg-blue-100/50 rounded-lg p-12 flex flex-col items-center justify-center transition-colors cursor-pointer group">
                    <input
                      type="file"
                      accept=".pdf,.doc,.docx"
                    ...
                    <div className="mb-3 transition-transform group-hover:scale-110">
                      {fileName ? (
                        ...
                        <Upload size={48} className="text-[#3B82F6]/40" />
                      )}
                    </div>
                    {fileName ? (
                  ...
                  {fileName && (
                    <div className="text-center mt-4">
                      <button
                        type="button"
                        onClick={() => setFileName("")}
                        className="text-[#3B82F6] text-sm font-bold underline bg-transparent border-0 cursor-pointer flex items-center gap-1 mx-auto"
                      >
                        <X size={13} />
                        Remove File
                      </button>
              ...
              {step === 5 && (
                <div>
                  ...
                  <ReviewSection
                    ...
                    onEdit={() => setStep(4)}
                  >
                    <div className="flex items-center gap-3 p-3 bg-blue-50 border border-[#3B82F6] rounded-lg">
                      <ClipboardList
                        size={24}
                  ...
                  <div className="flex items-start gap-3 p-5 bg-blue-50 border-2 border-[#3B82F6] rounded-lg mt-4">
                    <input
                      type="checkbox"
                      required
            ...
            <div className="flex-shrink-0 px-10 pt-4 pb-6 border-t-2 border-gray-100 bg-white rounded-b-xl">
                ...
                {[1, 2, 3, 4, 5].map((s) => {
                  ...
                  return (
                    <div key={s} className={`flex items-center ${s < 5 ? "flex-1" : ""}`}>
                      <div className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center transition-all duration-300 ${s < step ? "bg-[#3B82F6] text-white" : s === step ? "bg-[#0A1F5C] text-[#3B82F6] ring-4 ring-[#3B82F6]/40 scale-110" : "bg-gray-200 text-gray-400"}`}>
                        <Icon size={13} strokeWidth={2.5} />
                      </div>
                      {s < 5 && <div className={`flex-1 h-[3px] mx-1 rounded-full transition-all duration-300 ${s < step ? "bg-[#3B82F6]" : "bg-gray-200"}`} />}
                    </div>
                  );
                })}
              </div>
              ...
              <div className="flex justify-between gap-4">
                ...
                <button
                  ...
                  className={`flex-1 border-0 max-w-[160px] py-2 font-extrabold text-[16px] tracking-[2px] uppercase rounded transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 ${step === 5 ? "bg-[#3B82F6] text-white hover:bg-[#0A1F5C] hover:text-[#3B82F6]" : "bg-[#0A1F5C] text-white hover:bg-[#3B82F6] hover:text-white"}`}
                  style={{
                    fontFamily: "'Barlow Condensed',sans-serif",
                    boxShadow: step === 5 ? "0 4px 16px rgba(59,130,246,0.3)" : "0 4px 16px rgba(10,31,92,0.3)",
                  }}
                >
