            ...
            <div className="relative z-10">
              ...
              <div className="relative z-10 flex gap-12 justify-center mt-16 border-t border-[#FFD000]/20 pt-10">
                {[
                  ...
                  [
                    String(new Set(activeJobs.map((j) => j.department)).size),
                    "Departments",
                    Building2,
                  ],
              ...
              {jobsLoading ? (
                ...
                filtered.map((job) => (
                  ...
                  >
                    ...
                    <p className="mb-5">
                      <span className="inline-flex items-center gap-1 bg-[#EEF2FF] text-[#0A1F5C] text-[11px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-sm">
                        <Clock size={11} />
                        {job.type}
                      </span>
                    </p>
      ...
      {selectedJob && !isAdmin && (
        ...
        >
          ...
          >
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 z-10 w-9 h-9 bg-gray-100 hover:bg-[#CC1B1B] text-gray-500 hover:text-white rounded-full flex items-center justify-center transition-all cursor-pointer"
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                ...
                <div className="flex gap-3 flex-wrap justify-center">
                  <button
                    ...
                    className="flex items-center gap-2 bg-[#0A1F5C] text-[#FFD000] font-bold text-[15px] tracking-[2px] uppercase px-8 py-3.5 rounded hover:bg-[#CC1B1B] hover:text-white transition-all cursor-pointer"
                    style={{ fontFamily: "'Barlow Condensed',sans-serif" }}
                  >
                  ...
                  <button
                    onClick={closeModal}
                    className="flex items-center gap-2 bg-gray-100 text-[#0A1F5C] font-bold text-[15px] tracking-[2px] uppercase px-8 py-3.5 rounded hover:bg-gray-200 transition-all cursor-pointer"
                    style={{ fontFamily: "'Barlow Condensed',sans-serif" }}
                  >
                    <Home size={16} />
                    Back to Jobs
                ...
                <div className="flex-shrink-0 px-10 pt-4 pb-6 border-t-2 border-gray-100 bg-white rounded-b-xl">
                  <div className="flex items-center mb-3">
                    {[1, 2, 3, 4, 5].map((s) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center transition-all duration-300 ${s < step ? "bg-[#FFD000] text-[#0A1F5C]" : s === step ? "bg-[#0A1F5C] text-[#FFD000] ring-4 ring-[#FFD000]/40 scale-110" : "bg-gray-200 text-gray-400"}`}
                          >
                            <Icon size={13} strokeWidth={2.5} />
                          </div>
                          {s < 5 && (
                            <div
                              className={`flex-1 h-[3px] mx-1 rounded-full transition-all duration-300 ${s < step ? "bg-[#FFD000]" : "bg-gray-200"}`}
                            />
                          )}
                        </div>
                      );
                  ...
                  <div className="flex justify-between gap-4">
                    <button
                      ...
                      className="px-8 py-3.5 bg-gray-100 text-[#0A1F5C] font-bold text-[15px] tracking-[2px] uppercase rounded transition-colors hover:bg-gray-200 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer flex items-center gap-2"
                      style={{ fontFamily: "'Barlow Condensed',sans-serif" }}
                    >
                      <ChevronLeft size={16} />
                      Back
                    ...
                    <button
                      ...
                      className={`flex-1 max-w-[160px] py-2 font-extrabold text-[16px] tracking-[2px] uppercase rounded transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 ${step === 5 ? "bg-[#CC1B1B] text-white hover:bg-[#0A1F5C] hover:text-[#FFD000]" : "bg-[#FFD000] text-[#0A1F5C] hover:bg-[#CC1B1B] hover:text-white"}`}
                      style={{
                        fontFamily: "'Barlow Condensed',sans-serif",
                        boxShadow:
                          step === 5
                  ...
                  <div className="flex items-start justify-between px-6 py-5 gap-4 flex-wrap">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <span className="inline-block bg-[#FFF8D6] text-[#0A1F5C] text-[11px] font-bold tracking-[2px] uppercase px-2.5 py-0.5 rounded-sm border border-[#FFD000]">
                          {app.department}
                        </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-gray-400 text-[13px] mt-1">
              Review and manage applicants by department
            </p>
            <ChevronRight
              size={18}
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        <div className="flex items-center gap-3 mb-6 bg-white border-2 border-gray-200 rounded-lg px-4 py-3 focus-within:border-[#FFD000] transition-colors">
          ...
          <input
            ...
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="flex-1 outline-none text-[15px] text-[#0A1F5C] bg-transparent"
          />
        </div>

        <div className="space-y-3">
          {filtered.map((job) => {
            const dc = DEPT_COLORS[job.department] || {
              bg: "#F3F4F6",
              text: "#374151",
            };
            return (
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span
                      className="text-[11px] font-bold tracking-[2px] uppercase px-2.5 py-0.5 rounded-full"
...
function JobFormModal({ job, depts, types, onSave, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border-t-[6px] border-[#FFD000]"
        style={{ boxShadow: "0 40px 80px rgba(10,31,92,0.3)" }}
      >
        <div className="sticky top-0 bg-[#0A1F5C] px-8 py-5 flex items-center justify-between z-10">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 bg-white/10 hover:bg-[#CC1B1B] text-white rounded-full flex items-center justify-center cursor-pointer border-0"
          >
            <X size={14} />
          </button>
        </div>
        <div className="p-8 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className={labelCls}>
                Job Title <span className="text-[#CC1B1B]">*</span>
              </label>
              <input
                className={inputCls}
                placeholder="e.g. Software Engineer"
            ...
            <div>
              <label className={labelCls}>
                Department <span className="text-[#CC1B1B]">*</span>
              </label>
              <select
                className={inputCls}
            ...
            <div>
              <label className={labelCls}>
                Type <span className="text-[#CC1B1B]">*</span>
              </label>
              <select
                className={inputCls}
                value={form.type}
          ...
          <div>
            <label className={labelCls}>
              About the Role <span className="text-[#CC1B1B]">*</span>
            </label>
            <textarea
              className={`${inputCls} h-24 resize-none`}
          ...
          <div>
            ...
            {form.responsibilities.map((r, i) => (
              <div key={i} className="flex gap-2 mb-2">
                <input
                  ...
                  value={r}
                  onChange={(e) =>
                    setArr("responsibilities", i, e.target.value)
                  }
                />
                {form.responsibilities.length > 1 && (
                  <button
                    onClick={() => delArr("responsibilities", i)}
                    className="w-10 h-[46px] flex-shrink-0 bg-red-50 text-red-400 rounded border-2 border-red-200 hover:bg-red-500 hover:text-white cursor-pointer flex items-center justify-center transition-all"
                  >
                    <X size={14} />
                  </button>
                )}
            ...
            <button
              onClick={() => addArr("responsibilities")}
              className="flex items-center gap-1.5 text-[12px] font-bold tracking-wider uppercase text-[#6366F1] hover:text-[#0A1F5C] cursor-pointer bg-transparent border-0 mt-1"
            >
              <Plus size={14} />
              Add Responsibility
            </button>
            ...
            {form.requirements.map((r, i) => (
              <div key={i} className="flex gap-2 mb-2">
                <input
                  ...
                  value={r}
                  onChange={(e) => setArr("requirements", i, e.target.value)}
                />
...
function AdminApplications({ jobs }) {
  ...
  const byDept = depts
    .filter((d) => d !== "All")
    .reduce((acc, d) => {
      acc[d] = filtered.filter((a) => a.department === d);
      return acc;
    }, {});
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "dilg_applications.csv";
    a.click();
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-[#0A1F5C] px-8 py-8 border-b-4 border-[#FFD000]">
        <div className="max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-white/40 text-[13px] mt-1">
              {allApps.length} total · categorized by department
            </p>
          </div>
          <button
            onClick={exportCSV}
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {depts.map((d) => {
            const count =
              d === "All"
                ? filtered.length
                : filtered.filter((a) => a.department === d).length;
            const dc = DEPT_COLORS[d] || { bg: "#F3F4F6", text: "#374151" };
            return (
              <button
                key={d}
                onClick={() => setActiveDept(d)}
                className={`px-4 py-2 rounded-lg text-[12px] font-bold tracking-[1px] uppercase transition-all cursor-pointer border-2 flex items-center gap-1.5 ${activeDept === d ? "bg-[#0A1F5C] text-[#FFD000] border-[#0A1F5C]" : "bg-white text-gray-500 border-gray-200 hover:border-[#FFD000]"}`}
              >
                {d}{" "}
                <span
                  className={`rounded-full px-1.5 py-0.5 text-[10px] font-black ${activeDept === d ? "bg-[#FFD000] text-[#0A1F5C]" : "bg-gray-100 text-gray-500"}`}
                >
                  {count}
                </span>
              </button>
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {Object.values(byDept).every((a) => a.length === 0) && (
      ...
      {viewApp && (
        <ApplicantModal
          ...
          onStatusChange={(s) => handleStatusChange(viewApp.id, s)}
    ...
    <div className="bg-white border-2 border-gray-100 rounded-2xl overflow-hidden">
      ...
      {apps.length === 0 ? (
        <div className="px-6 py-8 text-center text-gray-400 text-[13px] font-semibold">
          No applications for this department.
        </div>
      ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-gray-400">
                    {app.applicantEmail} · {app.jobTitle} ·{" "}
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <select
                    ...
                    className="text-[12px] font-bold px-3 py-1.5 rounded-lg border-2 cursor-pointer outline-none transition-all"
                    style={{
        ...
        <div className="flex-1 overflow-y-auto px-8 py-6">
          ...
          <Section title="Work Experience">
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <Field label="Employer First Name" value={app.workEmployerFirstName} />
            </div>
          ...
          {app.fileName && (
            <Section title="Uploaded Document">
              <div className="flex items-center gap-3 p-3 bg-[#FFF8D6] border border-[#FFD000] rounded-lg">
                ...
                <div>
                  <p className="text-[14px] font-semibold text-[#0A1F5C]">
                    {app.fileName}
                  </p>
